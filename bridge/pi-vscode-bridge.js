...
export default function (pi) {
  ...
  const tools = [
    noParamsTool({
      ...
      promptGuidelines: [
        "Use VS Code bridge tools when the user asks about their current editor state, selection, diagnostics, symbols, definitions, type definitions, implementations, declarations, hovers, references, or workspace symbol search.",
        "These VS Code bridge tools are read-only and provide IDE/LSP context; they do not modify editor buffers or run editor actions.",
      ],
